...
\title{\begin{center}
       \bfseries\Large
    	Assignment 1\\
    	Of\\
    	Network \& Distributed System Lab (CS1052)\\
        \vskip1cm
...
\includegraphics[width=700pt]{Question25}
\end{flushleft}
...
The IP address of nitdgp.ac.in is \textbf{14.139.221.29} and the tcp port number for sending and receiving TCP segments for the connections are \textbf{39424} and \textbf{443} respectively.
